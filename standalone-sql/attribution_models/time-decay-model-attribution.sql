...
-- Decay: EXP(-0.00412 * hours_before), capped at 168 hours (7 days).
...
weighted AS (
  SELECT
    ...
    conversion_id,
    channel,
    EXP(-0.00412 * hours_before) AS raw_weight,
    EXP(-0.00412 * hours_before) / NULLIF(
      SUM(EXP(-0.00412 * hours_before)) OVER (
