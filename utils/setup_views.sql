...
-- | event_params WHERE key='source'/'medium'       | Event-level | Start    | Yes, on session_start|
...
-- ============================================================================
-- Extracts source, medium, campaign from event_params on session_start events.
-- This works on ALL GA4 exports including the public obfuscated sample.
